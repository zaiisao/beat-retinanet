        ...
        for j in range(batch_size):
            ...
            if self.fcos:
                ...
                if positive_anchor_indices_per_class.sum() > 0:
                    assigned_annotations_for_anchors = assigned_annotations_for_anchors[positive_anchor_indices_per_class, :]
                    ...
                    gt_widths  = assigned_annotations_for_anchors[:, 1] - assigned_annotations_for_anchors[:, 0]
                    gt_ctr_x   = assigned_annotations_for_anchors[:, 0] + 0.5 * gt_widths
                    # print("gt", gt_widths)
                    ...
                    if self.loss_type == "l1":
                        ...
                        target_left = assigned_annotations_for_anchors[:, 0]
                        target_right = assigned_annotations_for_anchors[:, 1]
